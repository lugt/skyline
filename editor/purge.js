 ...
 *        in the stream
 * returns: a string of characters representing 'input' in 
 */
...
// String of data goes in, Purger-encoded string comes out.
...
// Purger-encoded string goes in, decoded data comes out.
 ...
 *
 *     var hash = purge.sha1('Hello World')
 *     purge.sha1(process.stdin, function (err, data) {
 *       if (err) return console.log("Something went wrong: " + err.message)
 *       console.log("Your SHA1: " + data)
 *     }
 *     purge.sha1.file('/my/file/path', console.log)
 */
